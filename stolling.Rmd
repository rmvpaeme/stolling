...
<div>
  ...
  <select id="image-selector" onchange="updateImage();">
    ...
    <option value="./images/DOAC.drawio.svg">DOACs</option>
  </select>
</div>
...
<div>
  ...
  <img id="image-viewer" src="./images/stolling.drawio.svg" alt="Default Image" style="max-width: 80%; height: auto; margin-top: 0px;">
</div>
