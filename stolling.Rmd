...
heparine</option> <option value="./images/doac.drawio.svg">DOACs
(Xarelto/rivaroxaban, Eliquis/apixaban)</option>
<option value="./images/dabigatran.drawio.svg">DOACs
(Dabigatran/Pradaxa)</option>
