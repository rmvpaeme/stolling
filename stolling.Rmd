...
<div>
  ...
  <select id="image-selector" onchange="updateImage();">
    ...
    <option value="./images/doac.drawio.svg">DOACs (Xarelto/rivaroxaban, Eliquis/apixaban)</option>
    <option value="./images/dabigatran.drawio.svg">DOACs (Dabigatran/Pradaxa)</option>
...
![VTE. Bron https://www.uptodate.com/contents/venous-thrombosis-and-thromboembolism-vte-in-children-treatment-prevention-and-outcome](images/VTE.drawio.svg)
